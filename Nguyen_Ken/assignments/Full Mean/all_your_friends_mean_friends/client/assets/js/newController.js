app.controller('newController', ['$scope', 'friendsFactory', '$location', function($scope, friendsFactory, $location){
  ...
  */
  ...
  $scope.create = function(){
                    var newFriend = {};
                    newFriend.firstName = $scope.newFriend.firstName;
                    newFriend.lastName = $scope.newFriend.lastName;
                    newFriend.birthday = $scope.newFriend.birthday;
  ...
  $scope.delete = function(friendID){
                    friendsFactory.delete(friendID, function(returnedData){
                      console.log(returnedData);
                      index();
                      $location.url('/');
                    });
